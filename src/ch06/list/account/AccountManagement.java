...
public class AccountManagement {
    ...
    public AccountManagement() {// 계좌 목록 배열을 생성
        this.accountList = new ArrayList<Account>();
        this.scanner = new Scanner(System.in);   // 사용자 입력 객체 생성
    }
    ...
    public void addAccount(String accountNumber, double balance) {
        ...
        this.accountList.add(new Account(accountNumber, balance));
    ...
    public void showAccountList() {
        ...
        for (int i = 0; i < accountList.size(); i++) {
            System.out.println("계좌번호: " + "[" + accountList.get(i).getAccountNumber() + "] , " + "잔액: " + "[" + accountList.get(i).getBalance() + "]");
